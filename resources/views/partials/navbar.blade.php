<nav x-cloak x-data="{ menu: false, scrolled: false }" @scroll.window="scrolled = (window.pageYOffset < 10) ? false : true" class="sticky top-0 px-4 pt-4 pb-4 z-50 sm:px-8 sm:pt-6">
    <div :class="scrolled && 'bg-gray-400/60 backdrop-blur-lg rounded-2xl p-3'" class="transition-all duration-300 ease-in-out flex justify-between items-center z-[100]">
        {{-- Logo Nav --}}
    ...
    {{-- Nav Menu --}}
    <div class="fixed inset-0 left-1/2 -translate-x-1/2 transition-all duration-500 ease-in-out max-w-screen-sm w-full max-h-screen h-full backdrop-blur-xl bg-blue-100/60 z-20" :class="menu ? 'opacity-100 visible' : 'opacity-0 invisible'">
        <div class="min-h-full flex flex-col justify-between px-4 pt-20 pb-6 sm:px-8">
            ...
            <div class="grid grid-cols-12 gap-3 min-h-40 min-[550px]:gap-5">
                <div :class="menu && 'motion-preset-blur-right-lg motion-preset-fade'" class="col-span-12 bg-gradient-to-br from-blue-600 to-indigo-500 rounded-2xl p-6 shadow-lg shadow-indigo-500/60 order-2 min-[550px]:col-span-8 min-[550px]:order-1">
                ...
                <div class="grid grid-cols-12 col-span-12 gap-3 rounded-2xl order-1 min-[550px]:grid-cols-2 min-[550px]:col-span-4 min-[550px]:order-2">
                    <button :class="menu && 'motion-preset-blur-down-lg motion-preset-fade'" class="group col-span-12 flex justify-center items-center bg-gray-200 rounded-2xl border border-gray-300 shadow-lg hover:border-indigo-500/30 hover:shadow-indigo-500/30 max-[550px]:min-h-14 min-[550px]:gap-5 min-[550px]:col-span-2">
                        <span class="icon-[fluent--weather-moon-24-filled] w-7 h-7 bg-gradient-to-br from-slate-700 to-slate-500 group-hover:from-blue-600 group-hover:to-indigo-500 min-[550px]:w-8 min-[550px]:h-8"></span>
                    </button>
                    <a href="https://www.linkedin.com/in/muhammad-syafwan-ardiansyah" target="_blank" :class="menu && 'motion-preset-blur-up-lg motion-preset-fade'" class="relative group flex justify-center items-center bg-gray-200 rounded-2xl border border-gray-300 shadow-lg overflow-hidden hover:border-indigo-500 hover:shadow-indigo-500/30 max-[550px]:min-h-14 max-[550px]:col-span-6">
                        ...
                        <span class="icon-[mdi--linkedin] w-7 h-7 bg-gradient-to-br from-slate-700 to-slate-500 group-hover:from-blue-600 group-hover:to-indigo-500 min-[550px]:w-8 min-[550px]:h-8"></span>
                    </a>
                    <a href="https://github.com/Syafwan000/teymii" target="_blank" :class="menu && 'motion-preset-blur-up-lg motion-preset-fade'" class="relative group flex justify-center items-center bg-gray-200 rounded-2xl border border-gray-300 shadow-lg overflow-hidden hover:border-indigo-500 hover:shadow-indigo-500/30 max-[550px]:min-h-14 max-[550px]:col-span-6">
                        <span class="absolute -top-full -right-full bg-indigo-500 w-8 h-8 flex justify-start items-end rounded-full group-hover:transition-all group-hover:duration-300 group-hover:ease-in-out group-hover:-top-3 group-hover:-right-3">
                            <i class="icon-[fluent--arrow-up-right-24-filled] w-4 h-4 text-gray-200"></i>
                        </span>
                        <span class="icon-[mdi--github] w-7 h-7 bg-gradient-to-br from-slate-700 to-slate-500 group-hover:from-blue-600 group-hover:to-indigo-500 min-[550px]:w-8 min-[550px]:h-8"></span>
                    </a>
                </div>
            </div>
        </div>
