...
@section('content')
    <div class="max-w-[350px] w-full text-slate-700 flex flex-col gap-6 text-center dark:text-slate-300">
        <div class="space-y-2">
            <h1 class="inline-block text-5xl text-transparent bg-clip-text font-extrabold bg-gradient-to-br from-blue-500 via-violet-500 to-rose-500 dark:from-pink-100 dark:via-rose-300 dark:to-rose-400">500</h1>
            <h3 class="text-2xl font-bold">Server error</h3>
            <p>Internal server error, try again later</p>
        </div>
        <img class="w-52 h-52 mx-auto" src="{{ asset('assets/gif/cat-stress.gif') }}" alt="pls not again">
